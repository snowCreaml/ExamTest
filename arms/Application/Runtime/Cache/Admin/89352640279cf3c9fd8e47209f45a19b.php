...
<div class="container">
<h2>患者基础信息</h2>
<?php if(is_array($result1)): $i = 0; $__LIST__ = $result1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form action="/arms/index.php?m=admin&c=index&a=nxxxg" method="post">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="3" id="medicalhistory" name="medicalhistory1" value="<?php echo ($vo["medicalhistory1"]); ?>"></textarea>
    </div>
    <div class="form-group">
      <label for="previoushistory">既往病史:</label>
      <textarea class="form-control" rows="3" id="previoushistory" name="previoushistory1" value="<?php echo ($vo["previoushistory1"]); ?>"></textarea>
    </div>
    <div class="form-group">
      <label for="familyhistory">家族病史:</label>
      <textarea class="form-control" rows="3" id="familyhistory" name="familyhistory1" value="<?php echo ($vo["familyhistory1"]); ?>"></textarea>
