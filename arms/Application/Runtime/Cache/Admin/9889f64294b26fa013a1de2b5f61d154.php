	...
	<h2>查询结果</h2>
		<table class="table table-striped" border='0'>
			<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><a href='/arms/index.php?m=admin&c=index&a=nhzcx1&name=<?php echo ($vo["name"]); ?>&idnumber=<?php echo ($vo["idnumber"]); ?>'>详情</a></td>
			</tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</table>
		<a href="/arms/Application/Admin/View/Index/nhzcx.html" class="btn btn-default" role="button">返回继续查询</a>
	</div>
</body>
</html>