...
<div class="container">
	...
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			<form action="/arms/index.php?m=admin&c=index&a=hzcx" method="post">
		...
		<div id="menu1" class="tab-pane fade">
			<form action="/arms/index.php?m=admin&c=index&a=hzgl" method="post" enctype="multipart/form-data">
				<div class="form-inline">
					<label for="name">患者姓名:</label>
					<input type="text" class="form-control" id="name" name="name" placeholder="输入患者姓名">
				</div><br>
