...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#home">查询患者</a></li>
		<li><a data-toggle="tab" href="#menu1">添加患者</a></li>
	</ul>
	<br>
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			<form action="/arms/index.php?m=admin&c=index&a=nhzcx" method="post">
		...
		<div id="menu1" class="tab-pane fade">
			<form action="/arms/index.php?m=admin&c=index&a=nhzgl" method="post" enctype="multipart/form-data">
				<div class="form-inline">
					<label for="name">患者姓名:</label>
					<input type="text" class="form-control" id="name" name="name" placeholder="输入患者姓名">
				</div><br>
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="3" name="medicalhistory1" id="medicalhistory"></textarea>
				</div>
				...
				上传图片:<input type="file" onchange='PreviewImage2(this)' name="previoushistory2">
				...
				上传图片:<input type="file" onchange='PreviewImage3(this)' name="familyhistory2">
				<div id="imgPreview3" style='width:120px; height:100px;'>
				    <img id="img3" src="" width="60" height="48" />
				</div>
				<script>$("img:empty").hide();</script>
