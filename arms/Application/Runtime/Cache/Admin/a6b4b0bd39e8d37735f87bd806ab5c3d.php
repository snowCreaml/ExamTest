	...
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			<div class="row">
				...
				<div class="col-sm-6">
					<form action="/arms/index.php?m=admin&c=index&a=nczhz"  method="post">
		...
		<div id="menu1" class="tab-pane fade">
			<h2>普通通知</h2>
			<form action="/arms/index.php?m=admin&c=index&a=npttz" method="post">
			...
			<div class="form-group">
				<label for="contest">通知内容:</label>
				<textarea class="form-control" rows="3" name="contest" id="contest"></textarea>
			</div>
