...
<a href="/arms/Application/Admin/View/Index/hzgl1.html" class="btn btn-default" role="button">添加病例</a>
<a href="/arms/Application/Admin/View/Index/hzjg.html" class="btn btn-default" role="button">添加会诊结果</a>
<a href="/arms/index.php?m=admin&c=index&a=hzcx2&name=<?php echo ($vo["name"]); ?>&idnumber=<?php echo ($vo["idnumber"]); ?>" class="btn btn-default" role="button">修改患者信息</a>
<!-- <a href='/arms/index.php?m=admin&c=index&a=hzcx2&name=<?php echo ($vo["name"]); ?>&idnumber=<?php echo ($vo["idnumber"]); ?>'>修改患者信息</a>
<a href="/arms/Application/Admin/View/Index/hzjg.html">添加会诊结果</a>
<a href="/arms/Application/Admin/View/Index/hzgl1.html">添加病历</a>
 -->
<a href="/arms/Application/Admin/View/Index/hzcx.html" class="btn btn-default" role="button">返回继续查询</a></p>
</div>
</body>
</html>